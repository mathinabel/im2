...
public class NettyLongChannel {
    ...
    public static boolean  initNetty() {
        ...
        try {
            ...
            ChannelFuture future = bootstrap.connect("192.168.1.102", 8089).sync();
    ...
    public static void sendMsg(String fromuuid,String touuid,String msg){

        channel.writeAndFlush(ProtoConstant.SEND_MESSAGE+"|"+fromuuid+ "|"+touuid+ "|"+msg+"\r\n");
